...
namespace mystl 
{
    ...
    public:
        ...
        // ========================================================================
        // CONSTRUCTORS, DESTRUCTOR, CLASSIC RULE OF FIVE
        // ========================================================================
        ...
        // ERASE BY KEY (Returns the number of removed elements: 0 or 1)
        size_type erase(const Key& key) 
        {
            ...
            while (curr) 
            {
                ...
                {
                    if (!prev) {
                        buckets_[idx] = curr->next; // The element was the head of the bucket
                    } else {
                        prev->next = curr->next; // The element was in the middle/end of the chain
                    }
                    delete curr;
                    size_--;
                    return 1;
